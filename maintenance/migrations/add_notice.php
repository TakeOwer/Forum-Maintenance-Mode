...
class add_notice extends \phpbb\db\migration\migration
{
	...
	/**
	 * The notice text itself needs no migration: it lives in the language
	 * files, and the administrator's overrides are stored separately, so the
	 * new text appears on its own while customised wording is left untouched.
	 */
