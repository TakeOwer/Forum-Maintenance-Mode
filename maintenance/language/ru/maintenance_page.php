...
$lang = array_merge($lang, array(
	...
	'AGM_PAGE_ADMIN_BANNER' => 'Обслуживание ИДЁТ: пользователи видят страницу обслуживания. Вы видите обычный форум, потому что вы администратор. Чтобы увидеть то же, что и они, откройте форум в приватном окне или включите «Показывать страницу и администраторам» в панели.',
