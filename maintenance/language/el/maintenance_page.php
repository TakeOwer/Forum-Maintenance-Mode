...
$lang = array_merge($lang, array(
	...
	'AGM_PAGE_ADMIN_BANNER' => 'Η συντήρηση είναι ΕΝΕΡΓΗ: τα μέλη βλέπουν τη σελίδα συντήρησης. Εσείς βλέπετε το κανονικό φόρουμ επειδή είστε διαχειριστής. Για να τη δείτε όπως εκείνοι, ανοίξτε το φόρουμ σε ιδιωτικό παράθυρο ή ενεργοποιήστε «Εμφάνιση της σελίδας και στους διαχειριστές» στον πίνακα.',
