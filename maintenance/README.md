...
Le traduzioni della pagina vivono nei **file di lingua**, uno per cartella:
`language/<codice>/maintenance_page.php`. L'estensione legge da sola le cartelle presenti, quindi
per aggiungere una lingua basta copiarci dentro il file tradotto — nessuna modifica al codice. Chi
vuole contribuire ti manda quel file e tu lo metti al suo posto.

Sulla pagina il visitatore sceglie la lingua da un **menu a tendina** con i nomi per esteso.
